...
All the original software used in the official server which were downloaded are official free versions. The software and versions used are provided down below. I will not provide any downloads because you should download the software and plugins yourself, it supports the developers even if you're poor like me! (:
...
Kate
MultiMC
Fabric Mod Loader (KamiChan's Optimized Plus + Meteor Utility Client)
